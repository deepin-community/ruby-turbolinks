...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE".freeze, "README.md".freeze, "lib/turbolinks.rb".freeze, "lib/turbolinks/assertions.rb".freeze, "lib/turbolinks/redirection.rb".freeze, "lib/turbolinks/version.rb".freeze]
